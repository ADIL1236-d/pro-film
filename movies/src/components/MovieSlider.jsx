...
function MovieSlider({ title, movies, subtitle,   }) {
  ...
  const handlenMovieClick = (moviesId) => {
          ...
          >
            ...
            {movies.map((movie)=>{
              return (
                ...
                onClick={()=> handlenMovieClick(movie.id)}
                >
              <div className="rounded-lg overflow-hidden bg-neutral-800">
                <div className="relative aspect-[2/3]">
                  ...
                  { /* hover overlay */}
                  <div
                    className={'absolute inset-0 bg-gradient-to-t from-neutral-900/90 via-neutral-900/40 to-transparent flex-col justify-end p-4 opacity-100 group-hover:opacity-100 transition-all duration-300'}
                  >
                    <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300 space-y-3">
                      ...
                      <button className="w-full bg-purole-600 hover:bg-purple-700 text-white py-3 rounded-md flex items-center justify-center gap-1 transition-all text-sm">
                        {/* <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="h-4 w-4"
                          viewBox="0 0 20 20"
                        ...
                        >
                          <path
                            fillRule="evenodd"
                            d="M10 18a8 8 0 100-16 8 8 0 000 16zm9.555 7.168A1 1 0 008 8v4a1 1 0 01.555.832l3-2a1 1 0 00-1.6641-3-2z"
                            clipRule="evenodd"
                          />
                        </svg>
                        View Details */}
