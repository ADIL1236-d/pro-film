        ...
        <div className="wrap">
          ...
          <div className="content">
            <span className="char state-1">
              <span data-label="V" style={{"--i": 1}}>V</span>
              <span data-label="i" style={{"--i": 2}}>i</span>
              <span data-label="e" style={{"--i": 3}}>e</span>
              <span data-label="w" style={{"--i": 4}}>w</span>
            </span>
            <div className="icon">
              <div />
            </div>
            <span className="char state-2">
              ...
              <span data-label="i" style={{"--i": 5}}>i</span>
              <span data-label="l" style={{"--i": 6}}>l</span>
