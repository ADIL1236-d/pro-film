...
function MovieContent() {
  ...
  strokeWidth="{2}" 
  d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3l-3.132-7c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" 
  />
</svg>
  ...
  return (
    <>
     ...
     <div className='bg-gradient-to-b from-neutral-900 to-neutral-950'>
      ...
      subtile="Stay Updated with what averyone's watchin" 
      movies={trendingMovies} 
      id="trending"
      />
      <MovieSlider 
      title="Popular Movies" 
      subtile="Most watched movies right now" 
